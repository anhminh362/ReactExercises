  ...
  return (
    <div>
      ...
      <div className="main-content">
        <button
          className="rounded md:p-1 p-2 m-10 border-solid hover:bg-blue-600 hover:text-white border-blue-400 border-2"
          onClick={HandleShowClick}
        >
          {isShow ? "Hide" : "Show Content"}
        </button>
        {isShow && (
          <>
          ...
          <table className="  items-center border-separate border-spacing-2  rounded">
            <tr className=" ">
              {contents.map((content) => (
                ...
                <th key={content.id} className="text-blue-300">
                  {content.name}
                </th>
              ))}
            </tr>
            ...
            <tr className="">
              <td className=" text-gray-700 border border-slate-300 rounded">
                <ul className="px-5 py-3">
                  <li>
                    <b>Grabbing element references:</b>{" "}
                    document.querySelector(),..
                  </li>
                  <li>
                    <b>Creating and placing new nodes:</b>{" "}
                    createTextNode(),Node.createElement();
                  </li>
                  <li>
                    <b>Moving and removing elements:</b>{" "}
                    Node.removeChild(),remove()
                  </li>
                  <li>
                    <b>Manipulating styles:</b>Element.style.color = "white"
                  </li>
                  <li>
                    <a
                      className="text-blue-200"
                      href="https://www.w3schools.com/js/js_htmldom_document.asp"
                    >
                      More information
                    </a>
                  </li>
              ...
              <td className=" text-gray-700 border border-slate-300 rounded">
                <ul className="px-5 py-3">
                  ...
                  <li>
                    allows us to write HTML elements in JavaScript and place
                    them in the DOM.
                  </li>
                  <li>JSX converts HTML tags into react elements.</li>
                  <li>Class components and Function components</li>
                  <li>
                    Props are immutable.When you need interactivity, you’ll need
                    to set state.
                  </li>
                </ul>
              </td>
